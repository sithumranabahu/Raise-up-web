...
public class contactServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String sname = request.getParameter("sendername");
            String email= request.getParameter("emailaddress");
            String tele = request.getParameter("telephone");
            String subject = request.getParameter("sendersubject");
            String msg = request.getParameter("sendermessage");
            
            
            try {
            PreparedStatement stmt= con.prepareStatement("INSERT INTO inquary(id,sendername,email,telephone,subject,message) VALUES(null,?,?,?,?,?)",PreparedStatement.RETURN_GENERATED_KEYS);
